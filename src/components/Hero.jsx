...
const Hero = ({
	...
	return (
		<>
			<div className="relative h-auto w-auto flex flec-col">
				<div className="bg-theme clip-path  h-[85vh] lg:h-[75vh] md:h-[65vh] sm:h-[55vh] w-auto absolute top-0 left-0 right-0 opacity-100 z-10 "></div>
				<div className="relative opacity-100 z-20 grid items-center justify-items-center nike-container ">
					<div className=" grid item-center justify-items-center mt-28 md:mt-24 ">
					...
					<div className="">
						<img
							src={img}
							alt="hero-img/img"
							className="w-auto h-[45vh] lg:h-[35vh] md:h-[31vh] sm:h-[31vh] xsm:h-[19vh] transitions-theme -rotate-[25deg] hover:rotate-[0] crusor-pointer object-fill "
						/>
					</div>
				</div>
			</div>
