		...
		<>
			<div
				className={`relative bg-gradient-to-b ${color} ${shadow} grid items-center  rounded-xl py-4 px-5 transition-all duration-700 ease-in-out w-full hover:scale-105 ${
					ifExists ? "justify-items-start" : "justify-items-centers-center"
				}  `}
			>
				<div
				...
				>
					...
					<div className=" flex items-center gap-3 ">
						...
						<button
							type="button"
							className="bg-white/90 blur-effect-theme button-theme px-2 py-1 text-sm text-black shadow-sky-200"
							onClick={() => {
								onAddToCart();
								onCartToggle();
							}}
