...
const Clips = ({ clip, imgsrc }) => {
	return (
		<>
			<div className="relative h-28 w-32 rounded-xl overflow-hidden group cursor-pointer transition-all duration-300 lg:w-28 md:w-24 sm:w-16 lg:h-28 md:h-24 sm:h-16 ">
				<img
					src={imgsrc}
					alt="img/clips"
				...
				/>
				<div className="bg-white blur-effect-theme absolute top-11 left-11 lg:top-8 lg:left-9    right-0 opacity-100 z-[100] w-8 h-8 md:w-5 md:h-5 flex items-center justify-center rounded-full   ">
